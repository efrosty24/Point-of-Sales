    ...
    return (
        <div className="appcl-container">
            <div className="employee-management-card">
                ...
                {message && (
                    <div style={{ color: "#374151", background: "#F3F4F6", border: "1px solid #E5E7EB", padding: "8px 12px", borderRadius: 8 }}>
                        {message}
                    </div>
                )}
                ...
                <table className="employee-table">
                    ...
                    {(!currentRows || currentRows.length === 0) && (
                        <tr>
                            <td colSpan={9} style={{ textAlign: "center", color: "#6b7280", padding: "1rem" }}>
                                No employees found
                            </td>
                        </tr>
                    )}
                            ...
                            <form onSubmit={showEdit ? saveEdit : createEmployee} className="form-body">
                                {!showEdit && (
                                    <div className="input-group password-group">
                                        ...
                                        >
                                            {showPassword ? (
                                                <svg viewBox="-2.16 -2.16 28.32 28.32" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#404040" stroke-width="0.192">
