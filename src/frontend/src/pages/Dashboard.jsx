                    ...
                    <div className="order-modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <table className="sales-table">
                            ...
                            <tr>
                                ...
                                <td><strong>${formatCurrency(Number(selectedOrder.header.Tax || 0))}</strong></td>
                            </tr>
                            <tr>
                                <td colSpan={3} style={{ textAlign: "right" }}><strong>Grand Total:</strong></td>
                                <td><strong>${formatCurrency(selectedOrder.total + (Number(selectedOrder.header.Tax) || 0))}</strong></td>
                            </tr>
                            </tfoot>
                        </table>
                    </div>
