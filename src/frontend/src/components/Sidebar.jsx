            ...
            <ul className="sidebar-menu">
                ...
                <li className={`dropdown ${openDropdown ? "open" : ""}`}>
                    <button onClick={toggleDropdown} className="sidebar-link dropdown-toggle">
                        <svg width="24px" height="24px" viewBox="-1.92 -1.92 27.84 27.84" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {!collapsed && (
                            <svg width="16px" height="16px" viewBox="-1.92 -1.92 27.84 27.84" className={`arrow ${openDropdown ? "rotate" : ""}`} fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <path d="M6 15L12 9L18 15" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path>
                                </g>
                            </svg>
                        )}
                    </button>
                    ...
                    <ul className="dropdown-menu">
                        <li>
                            <a href="#users" className="sidebar-sublink">Users</a>
                        </li>
                        <li>
                            <a href="#roles" className="sidebar-sublink">Roles</a>
                        </li>
                    </ul>
                </li>
            </ul>
